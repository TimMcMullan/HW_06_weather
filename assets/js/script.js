...
function placeDataOnPage(url) {
    $.getJSON(url).then(function(data) {
        ...
        $('day1 .feelslike span').text(data.list[0].main.feelslike);
        ...
        $('day2 .feelslike span').text(data.list[0].main.feelslike);
        ...
        $('day3 .feelslike span').text(data.list[0].main.feelslike);
        ...
        $('day4 .feelslike span').text(data.list[0].main.feelslike);
        ...
        $('day5 .feelslike span').text(data.list[0].main.feelslike);
    })
